...
#		'</div>	';
	    ...
	    <input id="user" type="hidden" name="user" class="text_field" style="float:right;"/>
	    </div>
	    <div class="formSection">
	    <!-- label for="pass">Password </label -->
	    <input id="pass" type="hidden" name="pass" class="text_field" style="float:right;"/>
	    </div>

	    <div class="formSection">
	    <input type="hidden" value="Log in" id="submitbtn"  class=subbtn style="width:100%;">
	    </div>
	    <div class="formSection">
	    <input type="button" value="ENTER" id="guestloginbtn"  class="subbtn" style="width:100%;" onClick="javascript:guestlogin(this);" />
	    </div>
	    </form>
	    </div>
