...
<li> Currently only the <em> first chain</em> of the PDB file is recognized and only natural amino acids are 
allowed in the chain. If containing multiple models, only the <em> first model </em>will be read.
<li> The size limit of the uploaded pdb file is <font color="red">1M bytes</font> . Please cut or edit the structure before uploading if it's
a large structure or contains multiple models. 
