...
$mail_message = "Test abcd \n" .
		...
		"http://eris.unc.edu/ereubus/confirm.php?txt=12&userid=12 \n" .
		"from ip: \n";
		
$mail_headers = "From: eris server <shir@email.unc.edu> \r\nReply-To: <shir@email.unc.edu> \r\nX-Mailer: erebus PHP script" . phpversion ();
#mail("syin@email.unc.edu", $mail_subject, $mail_message, $mail_headers);
erebus_mail('shir@email.unc.edu', "No more that's it!", $mail_message);
#
#
#
