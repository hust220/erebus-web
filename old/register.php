...
$query="INSERT INTO $tableusers (username,password,firstname,lastname,email,organization,lastlogin) ".
	"VALUES('$username','$passmd5','$firstname','$lastname','$email','$organization',NOW()) ";
...
#mail("shir@email.unc.edu,dokh@med.unc.edu,syin@email.unc.edu", $mail_subject, $mail_message, $mail_headers);
